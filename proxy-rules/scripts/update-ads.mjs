...
const [goodbyeAdsBlockText, goodbyeAdsAllowText, catsTeamBlockText] = await Promise.all([
...
if (mergedBlockSet.size < 150_000) {
  throw new Error(`Merged block list is unexpectedly small: ${mergedBlockSet.size}`);
}
