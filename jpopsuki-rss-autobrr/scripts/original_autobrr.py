...
"""
Legacy batch importer retained for reference. It reads a private
subscriptions.json file and requires credentials through environment variables.
    ...
    for idx, item in enumerate(valid_items):
        ...
        if dry_run:
            ...
            if actual_interval != interval:
                print(f'[WARN] Feed interval mismatch! Requested={interval} but got={actual_interval}')
            else:
