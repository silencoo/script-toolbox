// Sub-Store script operator: sort nodes in one subscription by country.
// Use on the individual subscription: #noCache&countryorder=jp,us,hk,sg,nl,de,in.
// Supports 60 locations and English names; omit countryorder to retain input order.
...
function operator(proxies = [], targetPlatform, context) {
  ...
  return sortByCountry(input, (proxy) => classifySortCountry(proxy && proxy.name));
}
